...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jpnavarro-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/addoneit"
  #   chef.validation_client_name = "addoneit-validator"
  #   chef.validation_key_path = ".chef/addoneit-validator.pem"
  # end
end
